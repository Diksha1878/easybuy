<!-- Header start  -->
<nav class="ec-header menu_fixed">
    <!--Ec Header Top Start -->
                        ...
                        <div class="d-flex w-100 justify-content-between align-items-center ml-4 mx-md-0">
                            <div style="max-width: 6rem;">
                                <a href="{{ Url('/') }}"><img src="assets/images/logo/logo.png"
                                        alt="easybuy" /><img class="dark-logo"
                                        src="assets/images/logo/dark-logo.png" alt="easybuy"
                                        style="display: none;" /></a>
                            </div>
                            <div class="d-flex">
                                <div class="ec-header-user dropdown d-flex">
                                    <button class="dropdown-toggle mr-5 mr-sm-3 " style="z-index: 50;visibility:hidden"
                                        data-bs-toggle="dropdown">
                                        <img src="assets/images/icons/user.svg"
                                            class="svg_img header_svg" alt="dropdown icon" />
                                        </button>
                                    ...
                                    <a href="{{ Url('cart') }}" class="ec-header-btn pl-5 pl-sm-0">
                                        <div class="header-icon"><img src="assets/images/icons/cart.svg"
                                                class="svg_img header_svg" alt="cart icon" />
                                        </div>
                                        <span class="ec-header-count cart-count-lable">{{ CartUtil::cartCount() }}</span>
                                    </a>
                                    <a href="{{Url('wishlist')}}" class="ec-header-btn ec-header-wishlist pl-4 pl-sm-0">
                                        ...
                                        <span class="ec-header-count">{{ Common::getWishlist()->count() }}</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="align-self-center">
                        <div class="header-search">
                            <form class="ec-btn-group-form" action="{{ Url('/products') }}">
                                <input value="{{ request()->input('search'); }}" name="search" class="form-control ec-search-bar" placeholder="Search products..." type="text">
                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown d-lg-none">
                                <button class="dropdown-toggle" data-bs-toggle="dropdown"><img
                                        src="assets/images/icons/user.svg" class="svg_img header_svg" alt="dropdown icon" /></button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="dropdown-item" href="{{ Url('signup') }}">Signup</a></li>
                                    {{-- <li><a class="dropdown-item" href="checkout.html">Checkout</a></li> --}}
                                    <li><a class="dropdown-item" href="{{ Url('login') }}">Login</a></li>
