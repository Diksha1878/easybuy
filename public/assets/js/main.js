...
!(function (e) {
    ...
    var t,
        ...
        u =
            ...
            function (t, o) {
                2 === t && o > 52
                    ? ((d = t),
                      e("#ec-main-menu-desk").addClass("menu_fixed_up"))
                    : 1 === t &&
                      ((d = t),
    ...
    e.scrollUp({
        ...
        e(".ec-tools-sidebar .ec-change-rtl .ec-rtl-switch").click(function (
            t
        ) {
            t.preventDefault();
            var o = e("<link>", {
        ...
        e(".ec-tools-sidebar .ec-change-mode .ec-mode-switch").click(function (
            t
        ) {
            t.preventDefault();
            var o = e("<link>", {
    ...
    e(window).on("load", function () {
        ...
        e(document).on("click", ".btn-list", function (t) {
            var o = e(".shop-pro-inner"),
                s = e(".pro-gl-content");
            t.preventDefault(),
                o.addClass("list-view"),
                s.addClass("width-100");
        }),
        ...
        e(document).ready(function () {
            e(".ec-more-toggle1").click(function () {
                "More Sub Categories" ==
                e(".ec-more-toggle1 #ec-more-toggle1").text()
                    ? (e(".ec-more-toggle1 #ec-more-toggle1").text(
                          "Less Sub Categories"
                      ),
                      e(".ec-more-toggle1").toggleClass("active"),
                      e("#ec-more-toggle1-content").slideDown())
                    : (e(".ec-more-toggle1  #ec-more-toggle1").text(
                          "More Sub Categories"
                      ),
                      e(".ec-more-toggle1").removeClass("active"),
                      e("#ec-more-toggle1-content").slideUp());
            });
        }),
        e(document).ready(function () {
            e(".ec-more-toggle2").click(function () {
                "More Brands" == e(".ec-more-toggle2 #ec-more-toggle2").text()
                    ? (e(".ec-more-toggle2 #ec-more-toggle2").text(
                          "Less Brands"
                      ),
                      e(".ec-more-toggle2").toggleClass("active"),
                      e("#ec-more-toggle2-content").slideDown())
                    : (e(".ec-more-toggle2  #ec-more-toggle2").text(
                          "More Brands"
                      ),
                      e(".ec-more-toggle2").removeClass("active"),
                      e("#ec-more-toggle2-content").slideUp());
            });
        }),
        e(document).ready(function () {
            e(".ec-more-toggle").click(function () {
                "More Categories" == e(".ec-more-toggle #ec-more-toggle").text()
                    ? (e(".ec-more-toggle #ec-more-toggle").text(
                          "Less Categories"
                      ),
        ...
        e(document).ready(function () {
            e(".ec-faq-wrapper .ec-faq-block .ec-faq-content").addClass(
                ...
                e(".ec-faq-block .ec-faq-title ").click(function () {
                    ...
                    t.slideToggle("slow"),
                        e(".ec-faq-dropdown").not(t).slideUp("slow");
                });
        }),
        e(document).ready(function () {
            e(
    ...
    if (f) {
        if ((f, noUiSlider)) {
            ...
            noUiSlider.create(f, {
                start: [getParams("minPrice") || e, getParams("maxPrice") || t],
                connect: !0,
                step: o,
                range: { min: e, max: t },
